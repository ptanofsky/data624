...
The data setup below is appropriately borrowed from my work in the previoius assignment. The `set.seed` function is reset to match the value from before.
...
**Result:** The kNN model results in RMSE of 1.4025385and $R^2$ of 0.5479653 on the test set. A better $R^2$ compared to the Neural Networks model, but underperformed compared to the MARS model and SVM model.
...
data_for_plot <- cmp_full_data[,top_vars] %>%
...
featurePlot(data_for_plot, cmp_full_data$Yield)

  

###

vars <- c(top_vars, "Yield")
